...
namespace Hospital_Mangement_System {
    ...
    public partial class Hospital_dbDataSet : global::System.Data.DataSet {
        ...
        public partial class PatientDataTable : global::System.Data.TypedTableBase<PatientRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PatientRow AddPatientRow(string Patient_ID, string P_Name, string Address, int Age, string Gender, int Phone_No, string Disease) {
        ...
        public partial class PatientRow : global::System.Data.DataRow {
            ...
            public int Phone_No {
                get {
                    return ((int)(this[this.tablePatient.Phone_NoColumn]));
                }
                set {
...
namespace Hospital_Mangement_System.Hospital_dbDataSetTableAdapters {
    ...
    public partial class PatientTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Patient] WHERE (([Patient_ID] = @Original_Patient_ID) AND ([P_Name] = @Original_P_Name) AND ([Address] = @Original_Address) AND ([Age] = @Original_Age) AND ([Gender] = @Original_Gender) AND ([Phone_No] = @Original_Phone_No) AND ([Disease] = @Original_Disease))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Patient] ([Patient_ID], [P_Name], [Address], [Age], [Gender], [Phone_No], [Disease]) VALUES (@Patient_ID, @P_Name, @Address, @Age, @Gender, @Phone_No, @Disease);
SELECT Patient_ID, P_Name, Address, Age, Gender, Phone_No, Disease FROM Patient WHERE (Patient_ID = @Patient_ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Patient] SET [Patient_ID] = @Patient_ID, [P_Name] = @P_Name, [Address] = @Address, [Age] = @Age, [Gender] = @Gender, [Phone_No] = @Phone_No, [Disease] = @Disease WHERE (([Patient_ID] = @Original_Patient_ID) AND ([P_Name] = @Original_P_Name) AND ([Address] = @Original_Address) AND ([Age] = @Original_Age) AND ([Gender] = @Original_Gender) AND ([Phone_No] = @Original_Phone_No) AND ([Disease] = @Original_Disease));
SELECT Patient_ID, P_Name, Address, Age, Gender, Phone_No, Disease FROM Patient WHERE (Patient_ID = @Patient_ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Patient_ID, P_Name, Address, Age, Gender, Phone_No, Disease FROM dbo.Patie" +
                "nt";
        ...
        public virtual int Fill(Hospital_dbDataSet.PatientDataTable dataTable) {
        ...
        public virtual Hospital_dbDataSet.PatientDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Hospital_dbDataSet.PatientDataTable dataTable = new Hospital_dbDataSet.PatientDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Hospital_dbDataSet.PatientDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Hospital_dbDataSet dataSet) {
        ...
        public virtual int Delete(string Original_Patient_ID, string Original_P_Name, string Original_Address, int Original_Age, string Original_Gender, int Original_Phone_No, string Original_Disease) {
            ...
            this.Adapter.DeleteCommand.Parameters[5].Value = ((int)(Original_Phone_No));
        ...
        public virtual int Insert(string Patient_ID, string P_Name, string Address, int Age, string Gender, int Phone_No, string Disease) {
            if ((Patient_ID == null)) {
        ...
        public virtual int Update(string Patient_ID, string P_Name, string Address, int Age, string Gender, int Phone_No, string Disease, string Original_Patient_ID, string Original_P_Name, string Original_Address, int Original_Age, string Original_Gender, int Original_Phone_No, string Original_Disease) {
            if ((Patient_ID == null)) {
                throw new global::System.ArgumentNullException("Patient_ID");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string P_Name, string Address, int Age, string Gender, int Phone_No, string Disease, string Original_Patient_ID, string Original_P_Name, string Original_Address, int Original_Age, string Original_Gender, int Original_Phone_No, string Original_Disease) {
            return this.Update(Original_Patient_ID, P_Name, Address, Age, Gender, Phone_No, Disease, Original_Patient_ID, Original_P_Name, Original_Address, Original_Age, Original_Gender, Original_Phone_No, Original_Disease);
        }
    }
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        private int UpdateUpdatedRows(Hospital_dbDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._patientTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        private int UpdateInsertedRows(Hospital_dbDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._patientTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        private int UpdateDeletedRows(Hospital_dbDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._patientTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        public virtual int UpdateAll(Hospital_dbDataSet dataSet) {
            if ((dataSet == null)) {
